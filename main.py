...
# Allow DB override via environment variable (default: banking.db)
DB_NAME = os.getenv("DB_NAME", "banking.db")
...
def get_connection(db_name: str = DB_NAME):
    """Helper to get a connection + cursor (used by app and tests)."""
